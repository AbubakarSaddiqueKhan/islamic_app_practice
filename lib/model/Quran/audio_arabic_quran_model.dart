...
class AudioArabicQuranModel {
  int code;
  String status;
  Data data;
  AudioArabicQuranModel({
    required this.code,
    required this.status,
    required this.data,
  });

  AudioArabicQuranModel copyWith({
    int? code,
    String? status,
    Data? data,
  }) {
    return AudioArabicQuranModel(
      code: code ?? this.code,
  ...
  factory AudioArabicQuranModel.fromMap(Map<String, dynamic> map) {
    return AudioArabicQuranModel(
  ...
  factory AudioArabicQuranModel.fromJson(String source) =>
      AudioArabicQuranModel.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() =>
      'AudioArabicQuranModel(code: $code, status: $status, data: $data)';

  @override
  bool operator ==(covariant AudioArabicQuranModel other) {
...
class Edition {
  ...
  factory Edition.fromMap(Map<String, dynamic> map) {
    return Edition(
      ...
      direction: map['direction'] as Null,
    );
  }
