...
class WordByWordQuranModel {
  int code;
  String status;
  Data data;
  WordByWordQuranModel({
    required this.code,
    required this.status,
    required this.data,
  });

  WordByWordQuranModel copyWith({
    int? code,
    String? status,
    Data? data,
  }) {
    return WordByWordQuranModel(
      code: code ?? this.code,
  ...
  factory WordByWordQuranModel.fromMap(Map<String, dynamic> map) {
    return WordByWordQuranModel(
  ...
  factory WordByWordQuranModel.fromJson(String source) =>
      WordByWordQuranModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant WordByWordQuranModel other) {
