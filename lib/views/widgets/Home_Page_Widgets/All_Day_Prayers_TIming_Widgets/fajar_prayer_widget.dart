...
class FajarPrayerTimingWidget extends StatelessWidget {
  const FajarPrayerTimingWidget({super.key});
        ...
        BlocBuilder<AllPrayersTImingsOfSingleDayBloc,
          ...
          builder: (context, state) {
            if (state is AllPrayersTimingsOfSingleDayInitialState) {
              ...
              print("Loaded ..... State ");
              return Text(
                state.allPrayersTimingOfDay.data.timings.Fajr,
                style: const TextStyle(color: Colors.white),
              );
            }
          },
